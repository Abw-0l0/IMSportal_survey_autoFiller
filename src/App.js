...
function App() {
  ...
  return (
    <div className='flex p-1 bg-gray-400/20 w-fit h-fit'>
      <div className="w-96 h-64 bg-gray-100 flex flex-col items-center rounded-lg overflow-hidden shadow-sm">
        <h1 className="p-1 text-lg pt-0 font-bold uppercase text-black/90">Ims survey Auto Complete</h1>

        <hr className="w-72 border-gray-800/40"/>
        ...
        <button onClick={Apply} className="bg-green-700/80 w-11/12 text-white py-1 mt-2 rounded-lg hover:bg-gray-700 hover:translate-y-[2px] hover:shadow-md">Apply</button>
